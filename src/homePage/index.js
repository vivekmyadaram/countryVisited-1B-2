...
import VisitCountries from '../VisitCountryItem'
...
class CountriesHome extends Component {
  ...
  render() {
    ...
    const listVisited = Countries.filter(each => each.isVisited === true)
    return (
        ...
        <ul>
          {Countries.map(eachCountry => (
            <Country
              country={eachCountry}
              key={eachCountry.id}
              visitCountry={this.visitCountries}
            />
          ))}
        </ul>
        <ul>
